  ...
  in
    div [ style "padding-top" "2em", style "padding-top" "3em" ]
      [ div [ class "row" ]
          ...
          , div [ class "three columns", style "padding-top" "1.2em" ]
            [ button [ onClick ShowSubmitForm, class "button", style "display" "block" ] [ text "Request New Quote" ] ]
          , div [ class "three columns", style "padding-top" "1.2em" ]
            [ button [ onClick ShowResults, class "button", style "display" "block" ] [ text "Choose New Plans" ] ]
          ]
      ]
