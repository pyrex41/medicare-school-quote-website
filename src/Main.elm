  ...
  in
    div [ style "padding-top" "2em", style "padding-top" "3em" ]
      [ div [ class "row" ]
          ...
          , div [ class "five columns", style "padding-top" "1.2em" ]
              [ button [ onClick ShowSubmitForm, class "button", style "width" "50%" ] [ text "New Quote" ]
              , button [ onClick ShowResults, class "button", style "width" "50%" ] [ text "New Plans" ]
              ]
          ]
      ]
...
pdpSelectBox mplist selectedPdp handle =
  case mplist of
    Just plist ->
      div [class "six columns", class "offset-by-two columns"] [
        label
          [ ]
