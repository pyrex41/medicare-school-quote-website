  ...
  in
    div [ style "padding-top" "2em", style "padding-top" "3em" ]
      [ div [ class "row" ]
          ...
          , div [ class "six columns", style "padding-top" "1.2em" ]
            [ button [ onClick ShowSubmitForm, class "button", style "width" "45%", style "padding-right" "3em" ] [ text "Request New Quote" ]
            , button [ onClick ShowResults, class "button", style "width" "45%" ] [ text "Choose New Plans" ]
            ]
          ]
      ]
