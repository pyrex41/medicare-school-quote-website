    ...
    div [ ]
      [ div [ class "row" ]
          ...
          , div [ class "five columns" ]
              [ div [ class "row" ]
                [ button [ onClick <| LinkClicked (Browser.External dentalLink), class "button", target "_blank", style "width" "50%" ] [ text "Dental Quote" ]
              , button [ onClick <| LinkClicked (Browser.External docusignLink), class "button", target "_blank", style "width" "50%" ] [ text "Docusign" ]
                ]
              , div [ class "row" ] 
